...
rule build_clustered_population_layouts:
    ...
    benchmark:
        benchmarks("performances/build_clustered_population_layouts")
    resources:
        mem_mb=10000,
    message:
...
rule build_solar_rooftop_potentials:
    ...
    benchmark:
        benchmarks("performances/build_solar_rooftop_potentials")
    resources:
        mem_mb=10000,
    message:
...
rule cluster_gas_network:
    ...
    benchmark:
        benchmarks("performances/cluster_gas_network")
    resources:
        mem_mb=4000,
    message:
...
rule build_daily_heat_demand:
    ...
    benchmark:
        benchmarks("performances/build_daily_heat_demand_total")
    threads: 8
    resources:
        mem_mb=20000,
    params:
...
rule build_hourly_heat_demand:
    ...
    benchmark:
        benchmarks("performances/build_hourly_heat_demand_total")
    threads: 8
    resources:
        mem_mb=2000,
    params:
...
rule build_temperature_profiles:
    ...
    benchmark:
        benchmarks("performances/build_temperature_profiles/total")
    threads: 8
    resources:
        mem_mb=20000,
    params:
...
rule build_dh_areas:
    ...
    benchmark:
        benchmarks("performances/build_dh_areas")
    resources:
        mem_mb=2000,
    script:
...
rule build_geothermal_heat_potential:
    ...
    benchmark:
        benchmarks("performances/build_heat_source_potentials/geothermal")
    resources:
        mem_mb=2000,
    params:
        drop_leap_day=config_provider("enable", "drop_leap_day"),
...
rule build_ates_potentials:
    ...
    benchmark:
        benchmarks("performances/build_ates_potentials_geothermal_{horizon}")
    resources:
        mem_mb=2000,
    params:
...
rule build_river_heat_potential:
    ...
    benchmark:
        benchmarks("performances/build_river_water_heat_potential")
    threads: 1
    resources:
        mem_mb=20000,
    params:
...
rule build_sea_heat_potential:
    ...
    benchmark:
        benchmarks("performances/build_sea_water_heat_potential")
...
rule build_ptes_operations:
    ...
    benchmark:
        benchmarks("performances/build_ptes_operations_{horizon}")
    resources:
        mem_mb=2000,
    params:
...
rule build_solar_thermal_profiles:
    ...
    benchmark:
        benchmarks("performances/build_solar_thermal_profiles/total")
    threads: 16
    resources:
        mem_mb=20000,
    params:
...
rule build_biomass_potentials:
    ...
    benchmark:
        benchmarks("performances/build_biomass_potentials_{horizon}")
    threads: 8
    resources:
        mem_mb=2000,
    params:
...
rule build_clustered_co2_sequestration_potentials:
    ...
    benchmark:
        benchmarks("performances/build_clustered_co2_sequestration_potentials")
    threads: 1
    resources:
        mem_mb=4000,
    params:
...
rule build_salt_cavern_potentials:
    ...
    benchmark:
        benchmarks("performances/build_salt_cavern_potentials")
    threads: 1
    resources:
        mem_mb=2000,
    message:
...
rule build_industry_sector_ratios_intermediate:
    ...
    benchmark:
        benchmarks("performances/build_industry_sector_ratios_{horizon}")
    threads: 1
    resources:
        mem_mb=1000,
    params:
...
rule build_population_weighted_energy_totals:
    ...
    benchmark:
        benchmarks("performances/build_population_weighted_{kind}_totals")
    threads: 1
    resources:
        mem_mb=2000,
    params:
...
rule build_transport_demand:
    ...
    benchmark:
        benchmarks("performances/build_transport_demand")
    threads: 1
    resources:
        mem_mb=2000,
    params:
...
rule build_district_heat_share:
    ...
    benchmark:
        benchmarks("performances/build_district_heat_share_{horizon}")
    threads: 1
    resources:
        mem_mb=1000,
    params:
...
rule build_snapshot_weightings:
    ...
    benchmark:
        benchmarks("performances/time_aggregation_elec")
    threads: 1
    resources:
        mem_mb=5000,
    params:
...
rule build_egs_potentials:
    ...
    benchmark:
        benchmarks("performances/build_egs_potentials")
    threads: 1
    resources:
        mem_mb=2000,
    params:
