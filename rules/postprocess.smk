...
if config["foresight"] != "perfect":
    ...
    rule plot_base_network:
        ...
        benchmark:
            benchmarks("performances/plot_base_network")
        threads: 1
        resources:
            mem_mb=4000,
        params:
    ...
    rule plot_clustered_network:
        ...
        benchmark:
            benchmarks("performances/plot_clustered_network")
        threads: 1
        resources:
            mem_mb=4000,
        params:
    ...
    rule plot_power_network:
        ...
        benchmark:
            (RESULTS + "benchmarks/performances/plot_power_network_{horizon}")
        threads: 2
        resources:
            mem_mb=10000,
        params:
    ...
    rule plot_hydrogen_network:
        ...
        benchmark:
            (RESULTS + "benchmarks/performances/plot_hydrogen_network_{horizon}")
        threads: 2
        resources:
            mem_mb=10000,
        params:
    ...
    rule plot_gas_network:
        ...
        benchmark:
            (RESULTS + "benchmarks/performances/plot_gas_network_{horizon}")
        threads: 2
        resources:
            mem_mb=10000,
        params:
    ...
    rule plot_balance_map:
        ...
        benchmark:
            (RESULTS + "benchmarks/performances/plot_balance_map_{horizon}_{carrier}")
        threads: 1
        resources:
            mem_mb=8000,
        params:
...
rule make_summary:
    ...
    benchmark:
        RESULTS + "benchmarks/performances/make_summary"
    threads: 1
    resources:
        mem_mb=16000,
    params:
...
rule plot_balance_timeseries:
    ...
    benchmark:
        RESULTS + "benchmarks/performances/plot_balance_timeseries_{horizon}"
    threads: 16
    resources:
        mem_mb=10000,
    params:
...
rule plot_heatmap_timeseries:
    ...
    benchmark:
        RESULTS + "benchmarks/performances/plot_heatmap_timeseries_{horizon}"
    threads: 16
    resources:
        mem_mb=10000,
    params:
...
rule plot_cop_profiles:
    ...
    benchmark:
        RESULTS + "benchmarks/performances/plot_cop_profiles/{horizon}"
    resources:
        mem_mb=10000,
    script:
...
rule plot_interactive_bus_balance:
    ...
    benchmark:
        RESULTS + "benchmarks/performances/plot_interactive_bus_balance/{horizon}"
    resources:
        mem_mb=20000,
    params:
        plotting=config_provider("plotting"),
