    ...
    if not config["tyndp_scenario"]:
        ...
        rule retrieve_tyndp:
            ...
            input:
                ...
                h2_reference_grid_entsos=storage(
            ...
            output:
                ...
                nodes_zip=f"{TYNDP_DATASET['folder']}/Nodes.zip",
                elec_reference_grid=f"{TYNDP_DATASET['folder']}/Line data/ReferenceGrid_Electricity.xlsx",
                h2_reference_grid_entsoe=f"{TYNDP_DATASET['folder']}/Line data/ReferenceGrid_Hydrogen.xlsx",
                h2_reference_grid_entsos_zip=f"{TYNDP_DATASET['folder']}/StartingGrid2030.xlsx.zip",
                h2_reference_grid_entsos=f"{TYNDP_DATASET['folder']}/StartingGrid2030.xlsx",
                nodes=f"{TYNDP_DATASET['folder']}/Nodes/LIST OF NODES.xlsx",
