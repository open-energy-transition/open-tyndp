...
tyndp:
	snakemake resources/dev/tyndp-raw/maps/power-network.pdf --rerun-incomplete $(args)
	snakemake resources/dev/osm-prebuilt/maps/power-network.pdf --rerun-incomplete $(args)
