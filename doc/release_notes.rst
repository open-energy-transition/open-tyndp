...
* Use compressed PECD data from OET's Google Cloud Platform, reducing storage and caching requirements (https://github.com/open-energy-transition/open-tyndp/pull/121).
