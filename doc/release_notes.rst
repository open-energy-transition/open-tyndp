...
* Change dispatch of biomass and biogas generators in CBA by (a) adding marginal prices of buses to the generators' marginal costs and (b) including a slack of 40% in the `e_sum_min` (https://github.com/open-energy-transition/open-tyndp/pull/719). 
