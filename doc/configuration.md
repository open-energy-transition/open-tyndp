...
!!! warning
    Only `NT` is fully implemented and validated. `DE` and `GA` are incomplete and unsupported;
    see [Scenarios](scenarios.md).

**YAML Syntax**

```yaml
{{ yaml_section("tyndp_scenario") }}
```
