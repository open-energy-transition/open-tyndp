...
.. admonition:: What should I do if the Open-TYNDP workflow is not running through?
   ...
   9. **Re-create your environment**: In some rare cases the environment gets corrupted and needs to be re-created. An example is that out of nothing snakemake returns a runtime error without having changed the installed packages at all.
